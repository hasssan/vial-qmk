...
[3] = LAYOUT(
  ...
  _______,  KC_INS,  KC_PSCR,   KC_APP,  XXXXXXX,  XXXXXXX,                        KC_PGUP,  KC_HOME,  KC_PGUP, KC_PGDN,KC_END, KC_BSPC,
  _______, KC_LALT,  KC_LCTL,  KC_LSFT,  XXXXXXX,  XXXXXXX,                        KC_PGDN,  KC_LEFT, KC_DOWN, KC_UP,  KC_RGHT, KC_BSPC,
